...
static uint8_t key_map[]={8,12,10,0,7,8,4,1,5,2,3,6,9,11,1};   // SL3603
...
void APT_WORK_125HZ_VAL(void)
{
 ...
 // 全局灵敏度
	...
	APT_WriteChipReg(0x01,0x03);
	APT_WriteChipReg(0x02,0x03);
	APT_WriteChipReg(0x03,0x04);
