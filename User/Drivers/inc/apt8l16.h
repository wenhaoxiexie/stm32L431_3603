...
#define KEY0_DISA 0x04       // 0
#define KEY1_DISA 0x40       // 0
#define KEY2_DISA 0x01       // 1
#define KEY3_DISA 0x02       // 1
#define KEY4_DISA 0x20       // 0
#define KEY5_DISA 0x80       // 0
#define KEY6_DISA 0x04       // 1
#define KEY7_DISA 0x08       // 0
#define KEY8_DISA 0x10       // 0
#define KEY9_DISA 0x08       // 1
#define KEY10_DISA 0x02      // 0
#define KEY11_DISA 0x10      // 1
#define KEY12_DISA 0x01      // 0

#define KDR0_CH_10_EN      (uint8_t)~(KEY10_DISA)
#define KDR1_CH_10_EN      (uint8_t)0XFF

#define KDR0_CH_10_11_EN    (uint8_t)~(KEY10_DISA)
#define KDR1_CH_10_11_EN    (uint8_t)~(KEY11_DISA)

#define KDR0_CH_1_10_11_EN   (uint8_t)~(KEY1_DISA|KEY10_DISA)
#define KDR1_CH_1_10_11_EN   (uint8_t)~(KEY11_DISA)

#define KDR0_CH_1_2_10_11_EN   (uint8_t)~(KEY1_DISA|KEY10_DISA)
#define KDR1_CH_1_2_10_11_EN   (uint8_t)~(KEY2_DISA|KEY11_DISA)

#define KDR0_CH_1_2_3_10_11_EN  (uint8_t)~(KEY1_DISA|KEY10_DISA)
#define KDR1_CH_1_2_3_10_11_EN   (uint8_t)~(KEY2_DISA|KEY3_DISA|KEY11_DISA)

#define KDR0_CH_1_2_3_4_10_11_EN   (uint8_t)~(KEY1_DISA|KEY4_DISA|KEY10_DISA)
#define KDR1_CH_1_2_3_4_10_11_EN   (uint8_t)~(KEY2_DISA|KEY3_DISA|KEY11_DISA)

#define KDR0_CH_0_1_10_11_EN       (uint8_t)~(KEY0_DISA|KEY1_DISA|KEY10_DISA)
#define KDR1_CH_0_1_10_11_EN       (uint8_t)~(KEY11_DISA)

#define KDR0_CH_0_1_2_10_11_EN      (uint8_t)~(KEY0_DISA|KEY1_DISA|KEY10_DISA)
#define KDR1_CH_0_1_2_10_11_EN      (uint8_t)~(KEY2_DISA|KEY11_DISA)

#define KDR0_CH_0_1_2_3_10_11_EN     (uint8_t)~(KEY0_DISA|KEY1_DISA|KEY10_DISA)
#define KDR1_CH_0_1_2_3_10_11_EN     (uint8_t)~(KEY2_DISA|KEY3_DISA|KEY11_DISA)

#define KDR0_CH_0_1_2_3_4_5_10_11_EN  (uint8_t)~(KEY0_DISA|KEY1_DISA|KEY4_DISA|KEY5_DISA|KEY10_DISA)
#define KDR1_CH_0_1_2_3_4_5_10_11_EN  (uint8_t)~(KEY2_DISA|KEY3_DISA|KEY11_DISA)

#define KDR0_CH_2_8_10_11_EN       (uint8_t)~(KEY2_DISA|KEY8_DISA|KEY10_DISA)
#define KDR1_CH_2_8_10_11_EN       (uint8_t)~(KEY11_DISA)

#define KDR0_CH_2_8_10_EN          (uint8_t)~(KEY8_DISA|KEY10_DISA)
#define KDR1_CH_2_8_10_EN          (uint8_t)~KEY2_DISA
